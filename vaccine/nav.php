  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <ul class="navbar-nav me-auto mb-2 p-2 m-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="vaccine_view.php">Vaccination list</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="../location/location_view.php">Location list</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="../healthcare/healthcare_view.php">Healthcare list</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="../appiontment/index.php">Appioment list</a>
        </li>
      </ul>
      <form class="d-flex">
